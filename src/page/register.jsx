...
export default function Register() {
  ...
  return (
    <div className="min-h-screen bg-[radial-gradient(circle_at_top_left,_rgba(16,185,129,0.18),_transparent_35%),linear-gradient(135deg,#f5fff9_0%,#ffffff_45%,#ecfdf5_100%)] px-4 py-10 sm:px-6 lg:px-8">
      <div className="mx-auto flex max-w-6xl flex-col overflow-hidden rounded-[2rem] border border-emerald-100 bg-white shadow-2xl lg:flex-row">
        <div className="bg-gradient-to-br from-emerald-700 via-emerald-600 to-teal-500 p-8 text-white lg:w-[42%] lg:p-10">
          ...
          <div className="mt-8 rounded-[1.5rem] bg-white/15 p-5 backdrop-blur">
            <p className="text-sm text-emerald-50">For tenants and buyers</p>
        ...
        <div className="flex-1 p-8 sm:p-10 lg:p-12">
          <div className="mb-8 text-center lg:text-left">
            ...
            <p className="mt-2 text-slate-600">A few details and you’re ready to explore.</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <label className="block text-sm font-medium text-slate-700">
              I am a
              <select name="role" value={formData.role} onChange={handleChange} className="mt-2 w-full rounded-2xl border border-slate-200 px-4 py-3 outline-none transition focus:border-emerald-500">
          ...
          <p className="mt-8 text-center text-slate-600">
            Already have an account?{' '}<Link to="/login" className="font-semibold text-emerald-600 hover:underline">Login</Link>
          </p>
        </div>
      </div>
    </div>
